 ...
 * 
 * @author 陶祎祎
 * @TableName purchase_director_state
 */
@TableName(value ="purchase_director_state")
@Data
public class PurchaseDirectorState implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        PurchaseDirectorState other = (PurchaseDirectorState) that;
