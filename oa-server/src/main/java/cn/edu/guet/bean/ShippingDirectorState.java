 ...
 * 
 * @author 陶祎祎
 * @TableName shipping_director_state
 */
@TableName(value ="shipping_director_state")
@Data
public class ShippingDirectorState implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        ShippingDirectorState other = (ShippingDirectorState) that;
