 ...
 * 
 * @author 陶祎祎
 * @TableName process_payment_contract_info
 */
@TableName(value ="process_payment_contract_info")
@Data
public class ProcessPaymentContractView implements Serializable {
    /**
     * 加工货物名称
     */
    ...
    public boolean equals(Object that) {
        ...
        ProcessPaymentContractView other = (ProcessPaymentContractView) that;
        return (this.getGoodsName() == null ? other.getGoodsName() == null : this.getGoodsName().equals(other.getGoodsName()))
