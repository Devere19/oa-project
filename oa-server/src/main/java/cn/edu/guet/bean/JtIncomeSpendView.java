 ...
 * 
 * @author 陶祎祎
 * @TableName jt_income_spend_info
 */
@TableName(value ="jt_income_spend_info")
@Data
public class JtIncomeSpendView implements Serializable {
    /**
     * 
     */
    private Date iDate;
    ...
    public boolean equals(Object that) {
        ...
        JtIncomeSpendView other = (JtIncomeSpendView) that;
