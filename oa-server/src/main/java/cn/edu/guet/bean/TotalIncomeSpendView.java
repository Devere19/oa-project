 ...
 * 
 * @author 陶祎祎
 * @TableName total_income_spend_info
 */
@TableName(value ="total_income_spend_info")
@Data
public class TotalIncomeSpendView implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        TotalIncomeSpendView other = (TotalIncomeSpendView) that;
