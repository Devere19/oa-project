<template>
  <SysDialog :height="dialog.height" :width="dialog.width" :visible="dialog.visible" :title="dialog.title"
    ...
    <template #content>
      <el-tree ref="parentTree" :data="treedata.list" node-key="id" :props="defaultProps" empty-text="暂无数据"
        :show-checkbox="false" :highlight-current="true" @node-click="handleNodeClick" default-expand-all
